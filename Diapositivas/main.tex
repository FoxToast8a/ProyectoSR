...
\end{frame}
\begin{frame}
    Note que dado $\tau\in\Hs^2$ existe $g\in \text{PSL}(2,\Z)$ tal que $g\tau\in\mathcal{F}.$ Esto se tiene ya que dado tal $g$ un calculo nos muestra que
...
\begin{frame}{Marking}
    ...
    \begin{frame}
        Entonces siguiendo la construcción hecha para el Toro el espacio de Teichmuller de una superficie $X$ cerrada, es el conjunto de las superficies marcadas que son difeomorfas a $X$ módulo equivalencia.\\
        \vspace{0.3cm}
